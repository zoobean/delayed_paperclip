      ...
      if defined?(::Delayed::DeserializationError) # this is available in newer versions of DelayedJob. Using the newee Job api thus.
        ...
        def self.enqueue_delayed_paperclip(instance_klass, instance_id, attachment_name)
          ::Delayed::Job.enqueue(
            ...
            :queue => instance_klass.constantize.attachment_definitions[attachment_name][:delayed][:queue]
          )
        end
        ...
        def self.enqueue_delayed_paperclip(instance_klass, instance_id, attachment_name)
          ::Delayed::Job.enqueue(
            ...
            instance_klass.constantize.attachment_definitions[attachment_name][:delayed][:queue]
          )
        end
